...
backbone, fused by a trivial rank-average — reaches **out-of-fold pAUC 0.17376** at 15.8 M
...
| Best image (convnextv2_nano@224) | 0.15821 | 14.98 | 2.46 | 60.9 |
| **Stack rank-avg[GBDT, nano@224]** | **0.17376** | 15.84 | 2.46 | 60.9 |
...
Per-fold: tabular 0.1693 ± 0.0112, image 0.1591 ± 0.0091, **stack 0.1747 ± 0.0073** — the stack
...
| Image | nano@128 → nano@224; heavy backbones collapse | 0.153 → **0.158**; Swin/EVA 0.104/0.100 |
| Stack | rank-avg **wins** vs meta-LGBM vs gate vs +embeddings | **0.1738** vs 0.171 vs 0.150 vs <0.174 |
