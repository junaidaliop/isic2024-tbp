...
| **`convnextv2_nano` &#64;224 + EMA0.995 + mixup** | **0.15821** | best image — the sweet spot |
...
| + PCA image embeddings into GBDT | < 0.17376 | **hurts** |
...
| + PCA image embeddings into GBDT | < 0.1738 | 0.17376 | embeddings **hurt** |
